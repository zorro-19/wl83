#ifndef _EXT_WIFI_CONNECT_H_
#define _EXT_WIFI_CONNECT_H_
...
struct WIFI_INIT_INFO *ext_get_cur_wifi_info(void);
enum WIFI_MODE ext_get_cur_wifi_mode(void);
...
void network_set_cb(int (*cb)(void *, enum WIFI_EVENT, void *), void *priv);
