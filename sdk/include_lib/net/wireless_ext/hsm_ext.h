...
// Func: void EXT_HSM_STATE_Create(HSM_STATE *This, const char *name, HSM_FN handler, HSM_STATE *parent)
...
void EXT_HSM_STATE_Create(HSM_STATE *This, const char *name, HSM_FN handler, HSM_STATE *parent);

// Func: void EXT_HSM_Create(HSM *This, const char *name, HSM_STATE *initState)
...
void EXT_HSM_Create(HSM *This, const char *name, HSM_STATE *initState);

// Func: HSM_STATE *EXT_HSM_GetState(HSM *This)
// Desc: Get the current HSM STATE
// This: Pointer to HSM instance
// return|HSM_STATE *: Pointer to HSM STATE
HSM_STATE *EXT_HSM_GetState(HSM *This);

// Func: unsigned char EXT_HSM_IsInState(HSM *This, HSM_STATE *state)
...
unsigned char EXT_HSM_IsInState(HSM *This, HSM_STATE *state);

// Func: void EXT_HSM_Run(HSM *This, int event, void *param)
// Desc: Run the HSM with event
// This: Pointer to HSM instance
// event: int processed by HSM
// param: Parameter associated with int
void EXT_HSM_Run(HSM *This, int event, void *param);

// Func: void EXT_HSM_Tran(HSM *This, HSM_STATE *nextState, int event, void *param, void (*method)(HSM *This, void *param))
...
void EXT_HSM_Tran(HSM *This, HSM_STATE *nextState, int event, void *param, void (*method)(HSM *This, void *param));
...
extern void ext_fsm_ctor(fsm_t *me, fsm_state_handler_t init);
extern fsm_ret_t  ext_fsm_init(fsm_t *me, fsm_event_t *e);
extern void ext_fsm_dispatch(fsm_t *me, fsm_event_t *e);
