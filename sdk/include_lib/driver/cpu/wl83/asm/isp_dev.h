...
#define SEN_MBUS_SYNC0_VSYNC_SYNC1_HSYNC        (1 << 16)
...
typedef struct {
    ...
    s32(*sensor_check)(u8 isp_dev, u32 reset_gpio, u32 pwdn_gpio, char *iic_name);  /*sensor check online*/
    ...
    s32(*set_size_fps)(u8 isp_dev, u16 *width, u16 *height, u8 *freq);  /*sensor size control*/
    ...
    void (*sleep)();
    void (*wakeup)();
    void (*write_reg)(u8 isp_dev, u16 addr, u16 val);
    u16(*read_reg)(u8 isp_dev, u16 addr);
...
#define REGISTER_CAMERA(camera) \
	static isp_sen_t camera SEC_USED(.camera_dev)
