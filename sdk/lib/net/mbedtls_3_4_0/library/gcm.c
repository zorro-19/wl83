...
static const unsigned char key_test_data[MAX_TESTS][32] ALIGNE(4) = {
    {
...
static const unsigned char iv_test_data[MAX_TESTS][64] ALIGNE(4) = {
    {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00
    },
...
static const unsigned char additional_test_data[MAX_TESTS][64] ALIGNE(4) = {
    { 0x00 },
    {
...
static const unsigned char pt_test_data[MAX_TESTS][64] ALIGNE(4) = {
    {
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
    },
...
static const unsigned char ct_test_data[MAX_TESTS * 3][64] ALIGNE(4) = {
    { 0x00 },
    {
...
static const unsigned char tag_test_data[MAX_TESTS * 3][16] ALIGNE(4) = {
    {
    ...
    for (j = 0; j < 3; j++) {
        ...
        for (i = 0; i < MAX_TESTS; i++) {
            ...
            ret = mbedtls_gcm_crypt_and_tag(&ctx, MBEDTLS_GCM_ENCRYPT,
                                            ...
                                            buf, 16, tag_buf);
#if  0//defined(MBEDTLS_GCM_ALT)   //wl83 gcm_alt support iv != 12
