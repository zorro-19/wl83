                            ...
                            void *p_rng)
{
     ...
     */
#if defined(MBEDTLS_SSL_DTLS_CONNECTION_ID)
    unsigned char add_data[23 + MBEDTLS_SSL_CID_OUT_LEN_MAX] __attribute__((aligned(4)));
#else
    unsigned char add_data[13] __attribute__((aligned(4)));
#endif
    size_t add_data_len;
    size_t post_avail;
                            ...
                            mbedtls_record *rec)
{
     ...
     */
#if defined(MBEDTLS_SSL_DTLS_CONNECTION_ID)
    unsigned char add_data[23 + MBEDTLS_SSL_CID_IN_LEN_MAX] __attribute__((aligned(4)));
#else
    unsigned char add_data[13] __attribute__((aligned(4)));
#endif
    size_t add_data_len;
