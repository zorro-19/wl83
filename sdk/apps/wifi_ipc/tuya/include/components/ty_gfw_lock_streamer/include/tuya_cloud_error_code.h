...
#define OPRT_BUF_NOT_ENOUGH                 OPRT_BUFFER_NOT_ENOUGH
...
#define OPRT_HTTPS_RESP_UNVALID             OPRT_MID_HTTP_HTTPS_RESP_UNVALID
...
#define OPRT_VER_FMT_ERR                    OPRT_VERSION_FMT_ERR
...
#define OPRT_MSG_OUT_OF_LMT                 OPRT_MSG_OUT_OF_LIMIT
...
#define OPRT_NO_AUTHENTICATION              OPRT_AUTHENTICATION_NOT_FOUND
...
#define OPRT_NOT_EXISTS                     OPRT_NOT_EXIST
...
#define OPRT_ROUTER_NOT_FIND                OPRT_ROUTER_NOT_FOUND
...
#define OPRT_AUTH_FAIL                      OPRT_AUTHENTICATION_FAIL
...
#define OPRT_DEVICE_IS_SUB_NODE_OR_IN_ELECTION OPRT_SVC_HTTP_DEVICE_IS_SUB_NODE_OR_IN_ELECTION
