...
#define OPRT_GW_ZG_SUB_ERR27                               (-0x341b)  //-13339, 错误27:设备自恢复失败
#define OPRT_GW_ZG_SUB_ERR28                               (-0x341c)  //-13340, 错误28:设备群升失败
#define OPRT_GW_ZG_SUB_ERR101                              (-0x341d)  //-13341, 错误101:未扫描到网络
#define OPRT_GW_ZG_SUB_ERR102                              (-0x341e)  //-13342, 错误102:扫网错误
#define OPRT_GW_ZG_SUB_ERR103                              (-0x341f)  //-13343, 错误103:串口帧格式错误
#define OPRT_GW_ZG_SUB_ERR104                              (-0x3420)  //-13344, 错误104:串口ACK超时
#define OPRT_GW_ZG_SUB_ERR105                              (-0x3421)  //-13345, 错误105:网关回复错误
#define OPRT_GW_ZG_SUB_ERR106                              (-0x3422)  //-13346, 错误106:MCU一直处于wakeup状态
#define OPRT_GW_ZG_SUB_ERRCODE_MAX_CNT 35
...
/****************************************************************************
            the error code marco define for module IMM_P2P
****************************************************************************/
#define OPRT_IMM_P2P_INVALID_DATA                          (-0x7b00)  //-31488, 收到非法数据
#define OPRT_IMM_P2P_ERRCODE_MAX_CNT 1
