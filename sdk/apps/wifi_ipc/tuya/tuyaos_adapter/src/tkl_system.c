...
{
    // --- BEGIN: user implements ---
    SYS_TICK_T ticks = get_system_ticks();
    return ticks;
    // --- END: user implements ---
}
...
{
    // --- BEGIN: user implements ---
//    PR_DEBUG("tkl_system_get_millisecond:%d", get_system_ms());
    SYS_TIME_T time = get_system_ms();
    return time;
    // --- END: user implements ---
}
