...
u32 get_cfg_data_connect_by_name(u8 *name, u8 *data, u16 len, u16 *real_len)
{
    ...
    *real_len = 0;
    ...
    cfg_printf("read file req_len:%d ret_len:%x\n", (int)sizeof(cfg_head_t), cfg_head.len);
    cfg_puts("cfg_head:\n");
