...
#pragma bss_seg(".3th_profile_api.data.bss")
#pragma data_seg(".3th_profile_api.data")
#pragma const_seg(".3th_profile_api.text.const")
#pragma code_seg(".3th_profile_api.text")
#endif
#include <stdlib.h>
#include <string.h>
#include <unistd.h>
...
static void ai_tws_rx_from_sibling(void *_data, u16 len, bool rx)
{
    if (rx) {
        ...
        if (!rx_data) {
            printf("ai_tws_rx_from_sibling malloc fail\n");
            return ;
        }
