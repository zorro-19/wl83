...
static void test_timer_handler(void *p)
{
    ...
    if (test_data_count) {
        log_info("-spp_data_rate: %d bytes, %d kbytes-", test_data_count, test_data_count / 1024);
        test_data_count = 0;
    }
}
#endif
...
int transport_spp_flow_enable(u8 en)
{
    ...
    if (spp_channel) {
        ...
        /* log_info("transport_spp_flow_enable:%02x,%d,%d", spp_channel, en, ret); */
    }
#endif
