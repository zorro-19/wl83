...
static void lcd_1280x800_xxxx_backctrl(struct lcd_board_cfg *bd_cfg, u8 on)
{
...
static int lcd_1280x800_xxxx_init(struct lcd_board_cfg *bd_cfg)
{
    printf("lcd 1280x800_xxxx init ...\n");

    return 0;
}

static int lcd_1280x800_xxxx_check_id(struct lcd_board_cfg *bd_cfg)
{
    // TODO: check id
...
REGISTER_IMD_DEVICE_BEGIN(lcd_1280x800_xxxx_dev) = {
    .info = {
#ifdef USE_TEST_MODE
        .test_mode 	     = true,
#else
...
REGISTER_LCD_DEVICE_DRIVE(lcd_dev)  = {
    .logo            = "RGB_1280x800_XXXX",
    .type		     = LCD_RGB,
    .dev    	     = &lcd_1280x800_xxxx_dev,
    .init		     = lcd_1280x800_xxxx_init,
    .bl_ctrl	     = lcd_1280x800_xxxx_backctrl,
    .check           = lcd_1280x800_xxxx_check_id,
    .send_init_code  = NULL,
};
