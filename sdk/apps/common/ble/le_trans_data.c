...
static void trans_test_recv_data(void)
{
#if TEST_RECEIVE_DATA_RATE
    static u32 count = 0;
    static u32 recv_index;
...
void bt_ble_init(void)
{
    ...
    if (TEST_TRANS_TIMER_MS < 10) {
        sys_hi_timer_add(0, trans_test_recv_data, TEST_TRANS_TIMER_MS);
    } else {
        sys_timer_add(0, trans_test_recv_data, TEST_TRANS_TIMER_MS);
    }
#endif
}
