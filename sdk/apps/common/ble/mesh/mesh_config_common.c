 ...
 */
/*-----------------------------------------------------------*/
#if (TCFG_SIG_MESH_MODEL_SELECT == SIG_MESH_PROVISIONER)
...
#if (TCFG_SIG_MESH_MODEL_SELECT == SIG_MESH_PROVISIONER)
const u16 config_bt_mesh_proxy_pre_node_adv_interval = ADV_SCAN_UNIT(300); // unit: ms
#else
 ...
 */
/*-----------------------------------------------------------*/
#define MESH_ADV_BUFFER_COUNT           20
_WEAK_
...
const u16 config_bt_mesh_pb_adv_duration = 60; // 40unit: ms
const u32 config_bt_mesh_prov_retransmit_timeout = 300; // unit: ms
const u8 config_bt_mesh_prov_transaction_timeout = 14; // unit: s
const u8 config_bt_mesh_prov_link_close_timeout = 3; // unit: s
const u8 config_bt_mesh_prov_protocol_timeout = 15; // unit: s
 ...
 */
/*-----------------------------------------------------------*/
const char log_tag_const_v_MESH_HCI AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);
const char log_tag_const_i_MESH_HCI AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);
const char log_tag_const_d_MESH_HCI AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);
const char log_tag_const_w_MESH_HCI AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);
const char log_tag_const_e_MESH_HCI AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);

const char log_tag_const_v_MESH_GATT AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);
const char log_tag_const_i_MESH_GATT AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);
const char log_tag_const_d_MESH_GATT AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);
const char log_tag_const_w_MESH_GATT AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);
const char log_tag_const_e_MESH_GATT AT(.LOG_TAG_CONST) = CONFIG_DEBUG_LIB(FALSE);
