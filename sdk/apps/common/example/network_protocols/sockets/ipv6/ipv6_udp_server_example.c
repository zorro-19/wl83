...
static const char send_data[] = "IPv6 UDP Server Test!";
...
static void ipv6_udp_server_start(void *priv)
{
...
void ipv6_udp_server_main(void *priv)
{
    if (thread_fork("ipv6_udp_server_start", 10, 512, 0, NULL, ipv6_udp_server_start, NULL) != OS_NO_ERR) {
        printf("thread fork fail\n");
    }
}

late_initcall(ipv6_udp_server_main);
