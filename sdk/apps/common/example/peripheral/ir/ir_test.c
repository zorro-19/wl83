...
static void timer5_send_ir_init(u32 port)
{
...
static void timer5_send_ir_data(u32 ir_data)
{
    send_val = ir_data;
    send_cnt = 0;
...
static void timer5_send_ir_test_task(void *arg)
{
...
static int c_main_ir_send()
{
    os_task_create(timer5_send_ir_test_task, NULL, 10, 1000, 0, "timer5_send_ir_test_task");
    return 0;
}

late_initcall(c_main_ir_send);

#endif // USE_IR_SEND_TEST_DEMO
