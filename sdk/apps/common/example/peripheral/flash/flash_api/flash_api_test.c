...
#ifdef USE_FLASH_API_TEST_DEMO
static void flash_api_test_task(void *arg)
{
...
static int c_main_flash_api(void)
{
    os_task_create(flash_api_test_task, NULL, 12, 1000, 0, "flash_api_test_task");
    return 0;
}

late_initcall(c_main_flash_api);

#endif // USE_FLASH_API_TEST_DEMO
