...
typedef enum ee_ecc_group_t {
    EE_ECC_GROUP_P256R1  = 0,
    EE_ECC_GROUP_P384R1  = 1,
    EE_ECC_GROUP_C25519  = 2,
    EE_ECC_GROUP_ED25519 = 3, /* Not a group, but used for control later on. */
} ee_ecc_group_t;
 ...
 */
ee_status_t th_ecdh_create(void **pp_context, ee_ecc_group_t group);
