...
/* Main and Proc_0 in the Ada version             */
{
    ...
    */
    ...
    if (User_Time < Too_Small_Time) {
        ...
        Dhrystones_Per_Second = (double) Number_Of_Runs / (User_Time / Mic_secs_Per_Second);
        ...
        printf("VAX MIPS rating: %10.3f\n", Vax_Mips);
        printf("DMIPS/MHz: %10.2f\n", Vax_Mips / (clk_get("sys") / 1000000));
