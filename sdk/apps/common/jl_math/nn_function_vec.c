...
void vector_real_zs32_ys8_add_dot_product_xs8(void *zptr, void *yptr, void *xptr, short len)
{
    long config = VECZ_S32 |  VECY_S8 |  VECX_S8;
    vector_real_add_dot_product(zptr, yptr, xptr, len, config);
}
//=========================================================================
...
void vector_real_zs32_ys32_dot_product_xs32(void *zptr, void *yptr, void *xptr, short len, char q)
{
    long config;
...
void vector_real_zs32_x32_qdtsum(long *zptr, long *xptr, short len, char q)
{
    long config = VECZ_S32 | VECX_S32;
    vector_real_qdtsum(zptr, xptr, len, q, config);
}
...
//=========================================================================
// vector_real_zs32_sum_dot_product_xs32
// dw bit[1:0] : x_dw   2: s32  1: s16  0:s8
// dw bit[5:6] : z_dw   2: s32  1: s16  0:s8
// z_dw >= x_dw
//  -32 < Q < 32
...
// z, y, x buf size must be(32bit x n),  z_buf can be y_buf or x_buf
//=========================================================================
void vector_real_zs32_sum_dot_product_xs32(void *zptr, void *xptr, short len, char q)
{
    long config = VECZ_S32 |  VECX_S32;
    vector_real_sum_dot_product(zptr, xptr, len, q, config);
}
