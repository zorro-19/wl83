...
static isp_iq_params_t sp140a_dvp_iq_params = {
    .blc = {
        0, 0, 0, 0,
    },
    .lsc = {
    ...
    .adj = {
        0x100, 0x180, 0x180, 0, 0, 0,
        //0x100,0x100,0x100,0,0,0,0,
    },
    ...
    .ccm = {
        0x80 * 0.97,      0x80 * 0.01,      0x80 * 0.02,      0x00,
        0x80 * (-0.05),   0x80 * 1.10,      0x80 * (-0.05),   0x00,
        0x80 * (-0.04),   0x80 * (-0.04),   0x80 * 1.08,      0x00,
    },

    .dpc =   {(10 << 4), (5 << 4), (15 << 4)},
    .tnr =   {1, 32, 175, 25, 175, 25, 180, 0, {256, 256, 256, 256, 256, 256, 230, 230}},
    .nr =    {80, 15, 0},
    .shp =   {2, 20, 255, 255, 128, 64, 32, 32, 0, 8, 64, 4, 64},
    .cnr =   {1, 255, 80},
...
void *sp140a_dvp_get_iq_params()
{
    return (void *)&sp140a_dvp_iq_params;
}
