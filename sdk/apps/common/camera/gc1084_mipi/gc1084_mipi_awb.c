/*****************************************************************************************
 *  File Name:  gc1084_mipi_awb.c
 *  Created on: 2024/7/24
 *  Author:     xzpin
 ******************************************************************************************/

#include "asm/isp_alg.h"
#include "gc1084_mipi_awb.h"
...
static void gc1084_awb_post_process(u32 prob, u32 ev, u32 zone_type, u16 *r_gain, u16 *b_gain, void *data)
{
...
static isp_awb_ct2_params_t awb_ct2_params = {
    .awb_post_process = gc1084_awb_post_process,
...
static isp_awb_params_t gc1084_awb_params = {
...
void *gc1084_get_awb_params()
{
    return (void *)&gc1084_awb_params;
}
