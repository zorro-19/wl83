...
extern int update_prev_init(int channel);
extern int init_update_isp_scenes(u8 id);
extern int start_update_isp_scenes(u8 id);
extern int stop_update_isp_scenes(u8 id);
extern int isp_scenes_switch_timer_done(void);
